...
FROM OCRD T0  
    ...
    LEFT JOIN (SELECT oi.DocNum [invNum]
                ...
                INNER JOIN (SELECT i2.U_lmtrReadID, m2.U_mr_date, m2.U_mr_value FROM INV1 i2 
                            INNER JOIN [@mwa_meter_reading] m2 on m2.DocEntry = i2.U_lmtrReadID) s1 ON i1.U_lmtrReadID = s1.U_lmtrReadID

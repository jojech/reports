/* High Usage Parts with Low Mins */
--Requested by Randy
--Created by Jeremy 6/14/21
--GRABS PARTS IF: average usage over 6 months is greater than min level
...
GROUP BY x0.WhsCode
        ...
        , x1.MinStock
        , x1.MaxStock 
HAVING ((SUM(x0.month1)+SUM(x0.month2)+SUM(x0.month3)+SUM(x0.month4)+SUM(x0.month5)+SUM(x0.month6))/6) > x1.MinStock
ORDER BY x0.WhsCode
        , x0.ItemCode
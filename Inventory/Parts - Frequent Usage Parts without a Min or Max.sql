/* Often Used Parts w/o a Min or Max */
--Requested by Randy
--Created by Jeremy 6/14/21
--GRABS PARTS IF: average usage over 6 months is greater than or equal to 1 AND there is no min set
...
GROUP BY x0.WhsCode
        ...
        , x1.MinStock
        , x1.MaxStock 
HAVING ((SUM(x0.month1)+SUM(x0.month2)+SUM(x0.month3)+SUM(x0.month4)+SUM(x0.month5)+SUM(x0.month6))/6) >= 1
ORDER BY x0.WhsCode
        , x0.ItemCode